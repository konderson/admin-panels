...
<head>
        ...
        <link rel="stylesheet" href="{{asset('css/frontend_css/matrix-login.css')}}" />
...
<strong>{!! session('flash_message_error')!!}</strong>
    ...
    @endif
            ...
            <form id="loginform" class="form-vertical" method="post" action="{{url('admin')}}">{{csrf_field()}}
				 <div class="control-group normal_text"> <h3><img  src="img/logo.jpg" width="50px" height="50px" alt="Logo" /></h3></div>
        ...
        <script src="js/frontend_js/matrix.login.js"></script>
